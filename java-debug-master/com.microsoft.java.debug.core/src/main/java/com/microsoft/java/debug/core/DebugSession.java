...
public class DebugSession implements IDebugSession {
    ...
    public void start() {
        ...
        // TODO il faut mettre en place l'écoute des stepevent, classprepare, methodentry, methode exit
        EventRequest methodEntryRequest = vm.eventRequestManager().createMethodEntryRequest();
        methodEntryRequest.setSuspendPolicy(EventRequest.SUSPEND_NONE);
        methodEntryRequest.enable();

        EventRequest methodExitRequest = vm.eventRequestManager().createMethodExitRequest();
        methodExitRequest.setSuspendPolicy(EventRequest.SUSPEND_NONE);
        methodExitRequest.enable();

        EventRequest classPrepareRequest = vm.eventRequestManager().createClassPrepareRequest();
