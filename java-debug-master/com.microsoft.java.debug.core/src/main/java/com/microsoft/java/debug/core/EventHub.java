...
public class EventHub implements IEventHub {
    ...
    public void start(VirtualMachine vm) {
        ...
        System.out.println("EventHub thread created");
    ...
    @Override
    public Observable<DebugEvent> methodEntryEvents() {
        return this.events().filter(debugEvent -> debugEvent.event instanceof MethodEntryEvent);
    }

    @Override
    public Observable<DebugEvent> methodExitEvents() {
        return this.events().filter(debugEvent -> debugEvent.event instanceof MethodExitEvent);
    }

    @Override
    public Observable<DebugEvent> classPrepareEvents() {
        return this.events().filter(debugEvent -> debugEvent.event instanceof ClassPrepareEvent);
    }
